function myFunction() {
    ...
    document.getElementById('score').innerHTML = "Your score: " + count + " / 10";
    ...
    document.getElementById('score').innerHTML = "Your score: " + count + " / 10";
      if (document.getElementById('qxd').checked){
        count++;
        document.getElementById('qx').style.color = 'green';
    }else{
        document.getElementById('qx').style.color = 'red';
    }
    document.getElementById('score').innerHTML = "Your score: " + count + " / 10";
}
